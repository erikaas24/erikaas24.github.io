...
function startKnappTrykket() {
    ...
    skriveFeltEl.classList.toggle("active");
    ...
    if (antallRegistreringer > 0) {
        let plasseringTabell = document.querySelector("#tablePlassering");
        highscoreEl.removeChild(plasseringTabell);
...
function resetProgram() {
    ...
    //Gjør at den ikke toggler skriveFelt.active når man spamklikker reset
...
function InstruksjonsKnappTrykket() {
    ...
    if ((questionMarkTrykk % 2) != 0 && (highScoreTrykket % 2) != 0) {
        console.log("koden kjørte");
        highScoreButtonEl.classList.toggle("active");
        highscoreEl.classList.toggle("active");
        highScoreTrykket++;
        highScoreButtonEl.src = "./Bilder/leaderBoard.jpeg";
    }

}

function highScoreKnappTrykket() {
    highScoreTrykket++;
    highScoreButtonEl.classList.toggle("active");
    highscoreEl.classList.toggle("active");

    if ((highScoreTrykket % 2) == 0) {
        highScoreButtonEl.src = "./Bilder/leaderBoard.jpeg";
        /* navMidEl.innerText = "Trykk på start"; */
    } else {
        highScoreButtonEl.src = "./Bilder/x.png";
