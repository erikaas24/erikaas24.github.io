...
function skrivUtData() {
    ...
    db.collection("brukere").orderBy("Score", "desc").get().then((snapshot) => {
        ...
        for (let j = 0; j < 10; j++) {
            ...
            for (let i = 0; i < 3; i++) {
                ...
                if (i == 0) {
                    ...
                    //Koden genererer plasseringstallene. Gjør at hvis flere får samme score vil de få samme plassering. F.eks kan man ha to med plassering #1 Hvis de har samme score. Hvis det er to brukere med 1 plass, vil neste bruker da få tredjeplass.
                    ...
                    if (bruker.Score == bruker2.Score) {
                        ...
                        console.log((j+1)-antallLikeScore)
                        console.log("antalllik",antallLikeScore);
                        antallLikeScore++;
        ...
        antallLikeScore = 0;//Resetter antallLikeScore slik at det kan regnes ut på nytt ved ny generereing av tabellen
...
function registrerBruker() {
    ...
    //Sjekker om brukeren har registrert samme navn flere ganger
    if (antallVellykkedeRegistreringer > 0) {
        antallFeilMeldinger++
        registreringKnappEl.style.backgroundColor = "#f54242";
        feilMeldingEl.innerText = `Kun en registrering av gangen`;
        return
    }
