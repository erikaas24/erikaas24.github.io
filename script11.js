...
function nedTellingFunksjon() {
    ...
    if (antallSekunderGatt == 30) {
        ...
        if(localStorage.personalBest < WPM){
            ...
            /* leaderBoardEl.classList.toggle("active"); */ //Jeg fulgte forsalget ditt om å automatisk åpne leaderboardet hvis man får en ny personal best, men jeg synes brukeropplevelsen ble dårlig av det.
        };
